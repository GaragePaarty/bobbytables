<script lang="ts">
  ...
  async function getChatGPTResponse(prompt: string) {
    const chatGPTClient = new ChatGPTClient('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');
...
<p>Welcome to the best party of the year! We're throwing a garage paarty that you won't want to miss. Come hang out with us and enjoy some great music, drinks, and good times.</p>
<p>Don't forget to invite your friends! The more, the merrier. We'll have plenty of room for everyone. </p>
